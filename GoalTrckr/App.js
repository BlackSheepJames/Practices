...
export default function App() {
  ...
  return (
    <View style={styles.container}>
      <Image
        source={{
          uri: 'https://images.pexels.com/photos/1431283/pexels-photo-1431283.jpeg?auto=compress&cs=tinysrgb&w=600',
        }}
        style={{ width: 200, height: 200 }}
      />

      <Text style={{ fontSize: 45, color: 'green' }}>Goal Tracker</Text>
